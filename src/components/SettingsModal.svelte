    ...
    <div class="bg-white p-6 rounded shadow-md w-full max-w-sm">
        ...
        <div class="space-y-4">
            ...
            <div class="space-y-2">
                ...
                <label class="block">Corpus Cost (per m²):
                    <input type="number" bind:value={corpusCost} class="border p-1 w-full" />
                </label>
                ...
                <label class="block">Front Cost (per m²):
                    <input type="number" bind:value={frontCost} class="border p-1 w-full" />
                </label>
                ...
                <label class="block">Cut Cost (per m):
                    <input type="number" bind:value={cutCost} class="border p-1 w-full" />
                </label>
            </div>
